...
class myexception: public std::except {
    std::string message;
public:
    myexception(char* msg): message{std::string{msg}} {};
    myexception(std::string msg): message{std::move(msg)} {};
    myexception(std::string tag, std::string msg): message{std::format("{} : {}", tag, msg)} {}
    myexception(std::string tag, char* msg): message{std::format("{} : {}", tag, std::string{msg})} {}
    std::string what() {
        return message;
    }
}
...
class SDL_Cannot_Load_Media: public myexception {
    ...
    myexception("SDL Cannot Load Media",
                std::format("{} : {}",
                std::string{file}, msg)) {};
    SDL_Cannot_Cannot_Load_Media(char* file, char* msg):
    myexception("SDL Cannot Load Media",
                std::format("{} : {}",
                std::string:file},
                std::string{msg})) {};
